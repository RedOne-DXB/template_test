(() => {
    ...
    function initSliders() {
        let prevArrow = document.querySelectorAll(".swiper-arrow-prev");
        for (let i = 0; i < prevArrow.length; i++) {
            prevArrow[i];
            console.log(prevArrow);
        }
        let nextArrow = document.querySelectorAll(".swiper-arrow-next");
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 320 && isMobile.any) {
                ...
                if (document.querySelectorAll(".menu__item._hover") && targetElement.closest(".menu__item")) {
                ...
                if (document.querySelector(".search-form._active")) {
                    document.querySelector(".content-main__text").style.visibility = "hidden";
                    document.querySelector(".content-main__title").style.visibility = "hidden";
                    document.querySelector(".content-main").style.backgroundColor = "#fcf8f3";
                } else {
                    document.querySelector(".content-main__text").style.visibility = "visible";
                    document.querySelector(".content-main__title").style.visibility = "visible";
                    document.querySelector(".content-main").style.backgroundColor = "rgba(255, 255, 255, 0.72)";
                }
            }
        }
    };
